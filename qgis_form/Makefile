...
SOURCES = \
	__init__.py \
	QGIS_FORM.py QGIS_FORM_dialog.py

PLUGINNAME = QGIS_FORM

PY_FILES = \
	__init__.py \
	QGIS_FORM.py QGIS_FORM_dialog.py

UI_FILES = QGIS_FORM_dialog_base.ui
...
QGISDIR=C:\Users\816\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
